        ...
        <nav className="bg-primary dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div className="flex justify-between h-32">
                    ...
                    <div className="hidden sm:flex sm:items-center sm:ms-6">
                        <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex mr-20">
                            ...
                            <NavLink href={route('acabados.index')} active={route().current('acabados.index')}>
                                Acabados
                            </NavLink>
                        </div>
                        <div className="ms-3 relative">
                            <Dropdown>
                                ...
                                <Dropdown.Content>
                                    <Dropdown.Link href={route('profile.edit')}>Configuración</Dropdown.Link>
            ...
            <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                <div className="pt-2 pb-3 space-y-1">
                    ...
                    <ResponsiveNavLink href={route('acabados.index')} active={route().current('acabados.index')}>
                        Acabados
                    </ResponsiveNavLink>
                </div>
                ...
                <div className="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                    ...
                    <div className="mt-3 space-y-1">
                        <ResponsiveNavLink href={route('profile.edit')}>Configuración</ResponsiveNavLink>
